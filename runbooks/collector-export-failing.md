...
- **HTTP 503 from Loki `at least 1 live replicas required, could only find 0`** → Loki evicted itself from its ring (after a VM pause > heartbeat_timeout, P2-ISSUE-22; now 10m): `kubectl -n observability delete pod loki-0`.
