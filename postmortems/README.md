...
|---|---|---|---|---|---|---|---|---|
| 2026-09-25 | [GD1: orders charged, cart not cleared](2026-09-25-gd1-cart-not-cleared.md) | game day (not blind) | SEV2 | 10m21s (human; **monitoring: never**) | n/a | 10m52s | none (no SLO covered it) | 1 of 6 (AI-5, app team) |
